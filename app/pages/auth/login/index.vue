  ...
  <div class="flex items-stretch bg-secondary w-full" style="min-height: calc(100vh - 80px)">
    ...
    <div class="hidden lg:flex w-1/2 relative bg-primary items-center justify-center overflow-hidden">
      ...
      <div class="relative z-10 p-16 flex flex-col justify-end h-full w-full text-[#FFFAE6]">
        <h2 class="text-4xl font-bold mb-4 font-montserrat">Welcome Back.</h2>
        <p class="text-lg opacity-90 max-w-md">Log in to discover more timeless furniture designs to elevate your space.
        </p>
      </div>
    </div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-16 relative">
      <div class="w-full max-w-md flex flex-col gap-8">
        ...
        <div class="flex flex-col gap-2 text-center lg:text-left">
          <h1 class="text-3xl font-bold text-primary font-montserrat">Login</h1>
          <p class="text-primary/70">Welcome back! Please enter your details.</p>
        </div>
        ...
        <form @submit.prevent="handleLogin" class="flex flex-col gap-5">
          ...
          <div class="flex items-center justify-between text-sm">
            <label class="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" class="rounded border-primary/20 text-accent focus:ring-accent accent-accent" />
              <span class="text-primary/80">Remember me</span>
            </label>
            <a href="#" class="text-primary font-medium hover:text-accent transition-colors">Forgot password?</a>
          </div>

          <button type="submit"
            class="w-full bg-primary text-white py-3 rounded-full font-semibold hover:bg-primary/90 active:scale-[0.98] transition-all mt-2">
            Sign in
          </button>
        ...
        <p class="text-center text-sm text-primary/70">
          ...
          <NuxtLink to="/auth/register" class="text-primary font-semibold hover:text-accent transition-colors">
            Sign up</NuxtLink>
        </p>
